...
ALTER TABLE Reviews ADD FOREIGN KEY (userId) REFERENCES Users (id) ON UPDATE CASCADE ON DELETE CASCADE;

ALTER TABLE Reviews ADD FOREIGN KEY (prodId) REFERENCES Products (id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE Answers ADD FOREIGN KEY (questionId) REFERENCES Questions (id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE QuestionnaireLogs ADD FOREIGN KEY (userId) REFERENCES Users (id) ON UPDATE CASCADE ON DELETE NO ACTION;

ALTER TABLE QuestionnaireLogs ADD FOREIGN KEY (prodId) REFERENCES Products (id) ON UPDATE CASCADE ON DELETE CASCADE;
